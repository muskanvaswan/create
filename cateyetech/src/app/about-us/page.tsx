          ...
          <div className="space-y-6">
            <div className="rounded-2xl border border-ink-100 bg-ink-50/60 p-8">
              ...
              <dl className="mt-6 grid grid-cols-2 gap-6">
                {stats.map((stat) => (
                  <div key={stat.label}>
                    <dt className="text-2xl font-semibold tracking-tight text-ink-900">
                      {stat.value}
                    </dt>
                    <dd className="mt-1 text-[0.82rem] leading-snug text-ink-500">
                      {stat.detail}
                    </dd>
                  </div>
                ))}
            ...
            <div className="rounded-2xl border border-ink-100 bg-white p-8 shadow-card">
              ...
              <ul className="mt-5 space-y-3">
                {industries.map((industry) => (
                  <li
                    key={industry}
                    className="flex items-center gap-3 text-[0.95rem] text-ink-600"
                  >
