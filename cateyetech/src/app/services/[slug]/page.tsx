  ...
  return (
    <>
      ...
      <Section>
        <div className="grid gap-14 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl bg-ink-900 p-8">
              ...
              <Link
                href="/get-started"
                className="group mt-6 inline-flex items-center gap-2 rounded-full bg-brand-600 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-brand-700"
              >
                Get started
        ...
        <div className="mt-16 border-t border-ink-100 pt-14">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-3">
          {related.map((item) => (
            <Link
              ...
              className="group flex flex-col rounded-2xl border border-ink-100 bg-white p-7 shadow-card transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lift"
            >
